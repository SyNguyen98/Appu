...
public class SQL {
    ...
    public void createTable() {
        try {
            connection.createStatement().execute("CREATE TABLE MYTABLE(key varchar(50), answer1 varchar(100), answer2 varchar(100))");
        } catch (SQLException ex) {}
    ...
    private void insert(String k, String an1, String an2) {
        try {
