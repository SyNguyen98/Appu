...
public class EngSQL extends SQL {
    ...
    public EngSQL() {
     ...
     private void insertTableEng() {
        ...
        insert("video", "So many interesting videos, Lets watch it!", "Lets watch it!","Choose and click on once that you want to watch.","Lets see… what can I found…");
        ...
        insert("map", "Remember to *shut (me) down* before you go. ", "Here is the way …","Do not forget *way back home*.","Lets go !!!");
        insert("facebook", "Lets see… something news?", "Do you want to write something to newfeed? But I can not do this for you :P","Hmm, anyone is chatting with you…","Lets see… something news?");
        insert("mail", "Remember to check mail regularly … some company will send you request for something… that you really need", "Exercises are done! Lets submit them…","Lets see… It is have not something new…","Exercises are done! Lets submit them…");
        ...
        insert("open", "Your application will appear soon.", "Lets open it!","Wait a minute, it will be opened!","Your request will be done right now!");
        ...
        insert("what can you do for me", "I can do many things for you.", "Lets explore me, you will like me soon.","You can see what can I do for you in my Settings.","Lets explore me, you will like me soon.");
