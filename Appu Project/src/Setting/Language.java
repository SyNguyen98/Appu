...
public class Language {
    public static void setEnglish() {
        ...
        MainFrame.InputPanel.inputField.setText("Say something ...");
        OtherFrame.InformationFrame.versionLabel.setText("Version 2.1.7");
        OtherFrame.InformationFrame.infoLabel.setText("<html>   i.Sekai is a multimedia virtual assistant developed by a mystery anomyous team, written in Java."
    ...
    public static void setVietnamese() {
        ...
        MainFrame.InputPanel.inputField.setText("Hãy thử gõ gì đó ...");
        OtherFrame.InformationFrame.versionLabel.setText("Phiên bản 2.1.7");
        OtherFrame.InformationFrame.infoLabel.setText("<html>    i.Sekai là trợ lý ảo đa chức năng được phát triển bởi một nhóm bí ẩn, viết bằng ngôn ngữ Java."
