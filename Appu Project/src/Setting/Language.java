...
public class Language {
    public static void setEnglish() {
        ...
        try (BufferedReader br = new BufferedReader(new InputStreamReader(Language.class.getResourceAsStream("/Database/SuggestionEnglish.txt")))) {
        ...
        AutoSuggestor autoSuggestor = new AutoSuggestor(InputPanel.inputField, MainFrame.frame, null, new Color(0, 0, 102), Color.WHITE, Color.WHITE, 0.75f) {
            @Override
    ...
    public static void setVietnamese() {
        ...
        // <editor-fold defaultstate="collapsed" desc="Make suggestion">  
        List<String> keywords = new ArrayList<>();
        try (BufferedReader br = new BufferedReader(new InputStreamReader(Language.class.getResourceAsStream("/Database/SuggestionVietnamese.txt")))) {
            String line = br.readLine();
            while (line != null) {
                keywords.add(line);
                line = br.readLine();
